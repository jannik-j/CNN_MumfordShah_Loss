...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--segType', type=str, default='liver', help='liver, tumor')
        self.parser.add_argument('--semi_rate', type=int, default=3, help='rate of labels')
        ...
        self.parser.add_argument('--optim', type=str, default='Adam', help='network optimizer [Adam|SGD|RMS]')
